...
6. **التواصل المباشر مع الطلاب وأولياء الأمور (Direct Messaging with Students & Parents):**
   - انتقل إلى صفحة **"المحادثات والتواصل / Student Communications"** (`/teacher/communications`).
   - اختر الطالب **"Ahmad Al-Khatib"** من قائمة طلاب الشُعبة.
   - اضغط على قالب الاستفسار السريع: `🕒 دعوة لحضور الساعات المكتبية` أو اكتب رسالة مباشرة:
     > *"عزيزي أحمد، لاحظت تراجع درجاتك في اختبار منتصف الفصل الأخير، أدعوك لحضور الساعات المكتبية غداً لمراجعة المفاهيم الصعبة."*
   - اضغط على **"إرسال / Send"** لحفظ الرسالة فورياً في MySQL وإشعار الطالب بها.
