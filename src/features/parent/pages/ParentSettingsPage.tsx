    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="notifications" className="w-full space-y-6">
        <TabsList className="bg-slate-900/50 border border-white/10 p-1">
          <TabsTrigger value="notifications" className="data-[state=active]:bg-fuchsia-600 data-[state=active]:text-white">
            <BellRing className="w-4 h-4 mr-2" /> Notifications
          </TabsTrigger>
          <TabsTrigger value="consent" className="data-[state=active]:bg-fuchsia-600 data-[state=active]:text-white">
            <ShieldCheck className="w-4 h-4 mr-2" /> Consent Management
          </TabsTrigger>
          <TabsTrigger value="billing" className="data-[state=active]:bg-fuchsia-600 data-[state=active]:text-white">
        ...
        <TabsContent value="notifications" className="space-y-6 m-0 animate-in fade-in duration-300">
          <Card className="bg-slate-900/50 border-white/10">
            <CardHeader>
              <CardTitle className="text-xl text-white">Alert Preferences</CardTitle>
              <CardDescription className="text-slate-400">Choose how and when you receive updates about your children.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4 pb-6 border-b border-white/5">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex flex-col space-y-1">
                    <Label htmlFor="push" className="text-white text-base">Mobile Push Notifications</Label>
                    <span className="text-sm text-slate-400">Receive instant alerts via the mobile app/PWA.</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex flex-col space-y-1">
                    <Label htmlFor="email" className="text-white text-base">Email Notifications</Label>
                    <span className="text-sm text-slate-400">Receive detailed reports and alerts via email.</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex flex-col space-y-1">
                    <Label htmlFor="sms" className="text-white text-base">SMS Text Messages</Label>
                    <span className="text-sm text-slate-400">Receive critical alerts via SMS (carrier charges may apply).</span>
                  </div>
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-semibold text-slate-300 uppercase tracking-wider">Frequency</h3>
                <div className="max-w-xs">
                  <Label className="text-white mb-2 block">Alert Digest</Label>
                  ...
                  <p className="text-xs text-slate-400 mt-2">Critical safety alerts will always be sent immediately regardless of this setting.</p>
                </div>
              </div>
          ...
          <Card className="bg-slate-900/50 border-white/10">
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                  <CardTitle className="text-xl text-white">Data Consent Management</CardTitle>
                  <CardDescription className="text-slate-400">Manage platform permissions on behalf of your minor children.</CardDescription>
                </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-6 mt-4">
                <div className="flex items-start justify-between space-x-4">
                  <div className="flex flex-col space-y-1">
                    <Label htmlFor="child-data-consent" className="text-white text-base">Core Academic Processing</Label>
                ...
                <div className="flex items-start justify-between space-x-4">
                  <div className="flex flex-col space-y-1">
                    <Label htmlFor="child-ai-consent" className="text-white text-base">Advanced AI Analytics</Label>
                    <span className="text-sm text-slate-400">
        ...
        <TabsContent value="billing" className="space-y-6 m-0 animate-in fade-in duration-300">
          <Card className="bg-slate-900/50 border-white/10">
            <CardHeader>
              <CardTitle className="text-xl text-white">Tuition & Billing</CardTitle>
              <CardDescription className="text-slate-400">View balances and payment history.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="p-8 text-center border-2 border-dashed border-white/10 rounded-xl">
                <CreditCard className="w-12 h-12 text-slate-600 mx-auto mb-3" />
                <h3 className="text-lg font-medium text-slate-300">No balances due</h3>
